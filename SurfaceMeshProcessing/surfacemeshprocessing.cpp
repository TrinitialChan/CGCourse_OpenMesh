...
void SurfaceMeshProcessing::CreateActions(void)
{
	...
	//my
	actmyPrintAveArea = new QAction(tr("PrintAveArea"), this);
	actmyPrintAveArea->setIcon(QIcon(":/SurfaceMeshProcessing/Images/print.png"));
	actmyPrintAveArea->setStatusTip(tr("PrintAveArea"));
	actmyPrintAveArea->setCheckable(false);
	connect(actmyPrintAveArea, SIGNAL(triggered()), viewer, SLOT(PrintMyArea()));

	actmyPrintAveCircum = new QAction(tr("PrintAveArea"), this);
	actmyPrintAveCircum->setIcon(QIcon(":/SurfaceMeshProcessing/Images/print.png"));
	actmyPrintAveCircum->setStatusTip(tr("PrintAveCellCircum"));
	actmyPrintAveCircum->setCheckable(false);
	connect(actmyPrintAveCircum, SIGNAL(triggered()), viewer, SLOT(PrintMyCircum()));
	...
	//my
	agViewGroup->addAction(actmyPrintAveArea);
	agViewGroup->addAction(actmyPrintAveCircum);
	//end my
	...
	//my
	actBoundingSphere = new QAction("Bounding Sphere", this);
	actBoundingSphere->setIcon(QIcon(":/SurfaceMeshProcessing/Images/sphere.png"));
	actBoundingSphere->setStatusTip(tr("Show bounding Sphere"));
	actBoundingSphere->setCheckable(true);
	connect(actBoundingSphere, SIGNAL(toggled(bool)), viewer, SLOT(ShowBoundingSphere(bool)));


	
	actVertexVector = new QAction("Bounding Sphere", this);
	actVertexVector->setIcon(QIcon(":/SurfaceMeshProcessing/Images/vector.png"));
	actVertexVector->setStatusTip(tr("Show bounding Sphere"));
	actVertexVector->setCheckable(true);
	connect(actVertexVector, SIGNAL(toggled(bool)), viewer, SLOT(ShowVertexVector(bool)));
	//end my
...
void SurfaceMeshProcessing::CreateMenus(void)
{
	...
	//my
	menuRenderMode->addAction(actmyPrintAveArea);
	menuRenderMode->addAction(actmyPrintAveCircum);
	//end my
...
void SurfaceMeshProcessing::CreateToolBars(void)
{
	...
	//my
	tbView->addAction(actmyPrintAveArea);
	tbView->addAction(actmyPrintAveCircum);
	//end my
	//my
	tbView->addAction(actBoundingSphere);
	tbView->addAction(actVertexVector);
	//end my
}
