...
//my
void MainViewerWidget::ShowBoundingSphere(bool b)
{
	meshviewerwidget->SetDrawBoundingSphere(b);
}
void MainViewerWidget::ShowVertexVector(bool b)
{
	meshviewerwidget->SetDrawVertexVector(b);
}
//end my
...
//my function
void MainViewerWidget::PrintMyArea(void)
{
	meshviewerwidget->PrintMeshAveArea();
}

void MainViewerWidget::PrintMyCircum(void)
{
	meshviewerwidget->PrintMeshAveCellCircum();
}
